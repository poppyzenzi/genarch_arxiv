...
####### testing ancestry correlations #######

# all GWAS
df = pd.read_table("/Users/poppygrimes/Library/CloudStorage/OneDrive-UniversityofEdinburgh/Edinburgh/prs/"
                   "multiancestry/revafr_gen_cor_matrix.txt")
df.index = ['AFR', 'AMR', 'EAS','EUR']
...
# plot the heatmap with the mask
sns.heatmap(df, vmin=-1, vmax=1, annot=True, cmap=sns.color_palette("coolwarm", as_cmap=True), mask=mask)
