# ABCD3.0 - PCA Kmeans clustering for pop. stratification of genetic ancestries
library(tidyverse)
library(dplyr)
library(broom)
library(tidyr)
...
demo <- readRDS("/exports/eddie/scratch/s2421111/abcd/acspsw03.rds")
demo <- demo[!duplicated(demo$src_subject_id), ]

#import PCs generated from whole sample PCA
setwd("/exports/eddie/scratch/s2421111/genetics_QCed/genotyped/")
...
#write.table(african.only, "abcd4.0_africanonly_genotyped.txt", sep = ' ', quote=F, row.names=F, col.names=F)
